    ...
    <form>
      ...
      <div className="app-bg breakdown col-sm-12">
        <div className="row">
          ...
          <div className="col-sm-2">
            <input className="sm-input rightput" name="taxRate" value={values.calcs.taxRate || ''} onChange={handleCalcs} />
            <span>% Tax</span>
          </div>
          <div className="col-sm-2">
            Total
        ...
        <div className="row">
          ...
          <div className="col-sm-2">
            $<input className="sm-input" name="upfrontTax" value={values.calcs.upfrontTax || ''} onChange={handleCalcs} />
          </div>
          <div className="col-sm-2">
            <div>${round(sum(
        ...
        <div className="row">
          ...
          <div className="col-sm-2">
            $<input className="sm-input" name="fuelFreight" value={values.calcs.fuelFreight || ''} onChange={handleCalcs} />
          </div>
          <div className="col-sm-2">
            <div></div>
          </div>
        ...
        <div className="row">
          ...
          <div className="col-sm-2">
            $<input className="sm-input" name="lateCharges" value={values.calcs.lateCharges || ''} onChange={handleCalcs} />
          </div>
          <div className="col-sm-2">
            <div></div>
          </div>
        ...
        <div className="row">
          ...
          <div className="col-sm-2">
            $<input className="sm-input" name="miscItems" value={values.calcs.miscItems || ''} onChange={handleCalcs} />
          </div>
          <div className="col-sm-2">
            <div></div>
          </div>
