...
export default ({
  ...
  return (
    <div className='col-sm-9' onKeyPress={onKeyPress}>
      <form>
        ...
        <div className='app-bg breakdown col-sm-12'>
          ...
          <div className='row'>
            ...
            <div className='col-sm-2'>Upfront Tax</div>
            <div className='col-sm-2'>Monthly Tax</div>
            <div className='col-sm-2'>Total</div>
          </div>
          <div className='row'>
            <div className='col-sm-4'>
        ...
        <div className='app-bg col-sm-12' onKeyPress={onKeyPress}>
          <h3>Equipment</h3>
          <div className='row'>
                  ...
                  >
                    ...
                    <div className='col-sm-2 condense-gutters'>
                      ...
                      >
                        ...
                        <option value='Upgrade to Return'>
                          Upgrade to Return
                        </option>
                        <option value='Buyout to Keep'>Buyout to Keep</option>
                        <option value='Buyout to Return'>
                          Buyout to Return
                        </option>
